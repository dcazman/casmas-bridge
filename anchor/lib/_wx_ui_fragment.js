    // ── Weather panel — uses better_forecast (current + forecast) ─
        ...
        body.innerHTML=\`
          <div class="wx-panel">
            ...
            <div class="wx-row">
              ...
              <div class="wx-stat"><span class="wx-stat-val" style="color:\${precipColor}">\${d.precipChance}%</span><span class="wx-stat-lbl">Rain chance</span></div>
